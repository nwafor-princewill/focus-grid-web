...
const Testimonials: React.FC = () => {
  ...
  return (
    <section className="w-full bg-[#FFFFFF] pt-[100px]"> {/* Full width background + moved down */}
      <div className="max-w-[1440px] mx-auto flex flex-col items-center justify-center gap-[65px] py-20"> {/* Centered content container */}
        {/* Header Section */}
            ...
            {testimonialData.map((testimonial, index) => (
              ...
              >
                ...
                <div className="w-[522px] h-[80px] flex items-center gap-[69px]">
                  {/* Profile Image - Updated with actual image */}
