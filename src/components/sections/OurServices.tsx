...
const OurServices: React.FC = () => {
  ...
  return (
    <section className="w-full max-w-[1440px] mx-auto bg-white h-[608.81px] pt-[80px] pr-[99px] pb-[80px] pl-[99px] mt-[180px]">
      {/* Main container */}
            ...
            <div
              ...
              className={`w-[404px] h-[266.81px] rounded-[20px] p-5 flex flex-col gap-6 cursor-pointer transition-all ${
                activeCard === service.id
                  ? 'bg-[#E6F6EE] border border-[#00A550]'
                  : 'bg-[#E6F6EE] border border-[#333333]'
              }`}
            >
              {/* Icon Circle */}
              <div 
