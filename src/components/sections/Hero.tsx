      ...
      <div className="relative z-10 flex flex-col items-center justify-center pt-[220px] md:pt-[240px] px-4">
        <div className="w-full max-w-[751px] flex flex-col items-center gap-10">
          ...
          <div className="text-center animate-[fadeInUp_0.8s_ease-out_forwards]">
            <h1 className="text-[32px] md:text-[40px] lg:text-[48px] font-semibold leading-[120%] text-[#333333]" style={{ fontFamily: 'Funnel Display, sans-serif' }}>
              Build the Future Intentionally<br />
              with <span className="relative inline-block group">
                Focus!
                <img src={doodle} alt="" className="absolute -bottom-2 left-0 w-0 group-hover:w-full transition-all duration-700 h-[6px] object-cover" style={{ width: '100%', transitionDelay: '0.5s' }} />
              </span>
            </h1>
          </div>
          ...
          <div className="relative max-w-[603px] px-4 animate-[fadeInUp_1s_ease-out_forwards]">
            <div className="absolute top-0 -left-[200px] hidden lg:block">
              <div className="relative">
                <img src={cursor1} alt="" className="absolute w-[45.36px] h-[45.36px]" style={{ top: '-50px', left: '60px', zIndex: 20, animation: 'cursorDance 3s ease-in-out infinite' }} />
                <img src={scribble} alt="" className="w-[389.8px] h-[480px] object-top object-contain" style={{ marginTop: '-40px', animation: 'floatScribble 4s ease-in-out infinite' }} />
              </div>
            </div>
            <p className="text-base font-light leading-[140%] text-center text-[#545454] mt-4" style={{ fontFamily: 'Funnel Display, sans-serif' }}>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-5 justify-center w-full animate-[fadeInUp_1.2s_ease-out_forwards]">
            <Link to="/contact" className="w-full sm:w-auto">
              <button className="group w-full h-[48px] bg-[#00A550] rounded-[100px] px-[30px] py-[10px] flex items-center justify-center gap-2 transition-all duration-300 hover:bg-[#008f44] hover:scale-[1.02] hover:shadow-[0_4px_12px_rgba(0,165,80,0.1)]">
                <span className="text-sm font-medium leading-[140%] text-white whitespace-nowrap" style={{ fontFamily: 'Funnel Display, sans-serif' }}>LET'S BUILD</span>
            ...
            <Link to="/apply" className="w-full sm:w-auto">
              <button className="group w-full h-[48px] border-2 border-[#00A550] rounded-[100px] px-[30px] py-[10px] flex items-center justify-center gap-2 bg-transparent transition-all duration-300 hover:bg-[#00A550] hover:scale-[1.02] hover:shadow-[0_4px_12px_rgba(0,165,80,0.05)]">
                <span className="text-sm font-medium leading-[140%] text-[#00A550] whitespace-nowrap group-hover:text-white transition-colors duration-300" style={{ fontFamily: 'Funnel Display, sans-serif' }}>APPLY FOR INTERNSHIP</span>
