...
import sprinkle8 from '../../assets/images/sprinkle8.png';
...
const AboutHero: React.FC = () => {
  ...
  return (
    <section className="relative w-full min-h-[700px] overflow-hidden bg-white -mt-[120px] lg:-mt-[160px]">
      <style>
        {`
        ...
        <div className="flex flex-col lg:flex-row items-start md:items-center lg:items-start justify-between relative">
          ...
          <div className={`relative mt-20 lg:mt-[-50px] lg:mr-[-20px] transition-all duration-1000 delay-300 transform ${isVisible ? 'opacity-100 translate-x-0 scale-100' : 'opacity-0 translate-x-10 scale-90'}`}>
            ...
            <img 
              src={blob} 
              alt="" 
              className="absolute top-[55%] left-[50%] -translate-x-1/2 -translate-y-1/2 min-w-[310px] h-auto z-0 opacity-50"
              style={{ 
                width: '310.1px', 
                height: '431.4px'
              }}
            ...
            {/* Main Image - Static */}
            <div className="relative z-10 w-[350px] md:w-[450px] lg:w-[500px] h-auto">
              <img 
                src={aboutUsImg} 
                alt="About Us" 
