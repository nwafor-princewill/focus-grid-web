  ...
  return (
    ...
    <section className="relative w-full bg-white flex justify-center px-4 mt-8 md:mt-20 mb-[80px] md:mb-[160px] overflow-visible">
      ...
      >
        ...
        <div className="absolute -left-6 -bottom-8 opacity-[0.08] pointer-events-none">
        ...
        <div className="absolute left-[15%] top-4 opacity-[0.05] pointer-events-none">
            <img src={questionImg} alt="" className="w-[60px] md:w-[90px] h-auto grayscale rotate-[-20deg]" />
        </div>
        <div className="absolute right-[12%] top-[30%] opacity-[0.06] pointer-events-none">
            <img src={questionImg} alt="" className="w-[50px] md:w-[70px] h-auto grayscale" />
        </div>
        <div className="absolute left-[40%] bottom-4 opacity-[0.1] pointer-events-none">
