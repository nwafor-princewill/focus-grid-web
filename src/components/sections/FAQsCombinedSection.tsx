...
const FAQsCombinedSection: React.FC = () => {
  ...
  return (
    <div className="relative w-full bg-white" style={{ minHeight: '1400px' }}>
      ...
      {/* --- GREEN BACKGROUND --- */}
      <section className="relative w-full max-w-[1440px] mx-auto h-[954px] bg-[#00A550] flex flex-col items-center pt-[120px] md:pt-[180px] overflow-hidden">
              ...
              <div key={faq.id} className="w-full">
                <div 
                  ...
                  className={`w-full transition-all duration-500 cursor-pointer rounded-[20px] p-6 md:px-8 flex flex-col justify-center
                    ${isExpanded ? 'bg-[#54C38A] text-white shadow-lg translate-y-[-2px]' : 'bg-white text-[#333333] hover:bg-gray-50 border-b border-[#F5F5F5]'}`}
                  style={{
